...
import (
	...
	"github.com/hchenc/pager/pkg/client/clientset/versioned/scheme"
...
// DevopsV1alpha1Client is used to interact with features provided by the devops group.
type DevopsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DevopsV1alpha1Client) Pagers(namespace string) PagerInterface {
	return newPagers(c, namespace)
}
